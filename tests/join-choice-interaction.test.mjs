...
assert(html.includes('{ id:44, titre:"Choisir le bon JOIN"'), 'le cours 44 reste identifié');
...
assert(serviceWorker.includes('requete-2026-09-04-resultats-code-premium-v275'), 'cache de production renouvelé');
