...
assert(studio.includes("CAST('29.956' AS DECIMAL(10,2))") && studio.includes('nombre maximal de chiffres au total') && studio.includes('8 chiffres avant la virgule') && !studio.includes('les deux nombres ont un rôle') && !studio.includes('précision totale'), 'DECIMAL(10,2) expliqué');
...
assert(serviceWorker.includes('requete-2026-09-13-cf-implicit-v679'), 'cache de production renouvelé');
