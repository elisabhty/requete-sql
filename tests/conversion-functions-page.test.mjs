...
assert(guides.includes("k:'date'") && guides.includes("CAST('2026-09-12' AS DATE)") && guides.includes("date('2026-09-12')") && !guides.includes('12 septembre'), 'texte vers date, avec date() côté SQLite');
...
assert(serviceWorker.includes('requete-2026-09-12-cf-ex-v664'), 'cache de production renouvelé');
