...
assert(serviceWorker.includes('requete-2026-09-26-jtypes-v1104') && html.includes('requete-2026-09-26-jtypes-v1104') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
