...
assert(serviceWorker.includes('requete-2026-09-27-alias2-v1121') && html.includes('requete-2026-09-27-alias2-v1121') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
