...
assert(serviceWorker.includes('requete-2026-09-27-memo-v1126') && html.includes('requete-2026-09-27-memo-v1126') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
