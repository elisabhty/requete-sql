...
assert(serviceWorker.includes('requete-2026-09-26-selfsit-v1111') && html.includes('requete-2026-09-26-selfsit-v1111') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
