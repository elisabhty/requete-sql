...
assert(serviceWorker.includes('requete-2026-09-27-mission49-v1130') && html.includes('requete-2026-09-27-mission49-v1130') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
