...
assert(serviceWorker.includes('requete-2026-09-27-mission2-v1119') && html.includes('requete-2026-09-27-mission2-v1119') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
