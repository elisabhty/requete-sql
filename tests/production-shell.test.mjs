...
assert(serviceWorker.includes('requete-2026-09-27-gap-v1122') && html.includes('requete-2026-09-27-gap-v1122') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
