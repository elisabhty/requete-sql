...
assert(serviceWorker.includes('requete-2026-09-26-nonantes-v1108') && html.includes('requete-2026-09-26-nonantes-v1108') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
