...
assert(serviceWorker.includes('requete-2026-09-27-alias-v1120') && html.includes('requete-2026-09-27-alias-v1120') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
