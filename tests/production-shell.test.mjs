...
assert(serviceWorker.includes('requete-2026-09-27-nopers-v1124') && html.includes('requete-2026-09-27-nopers-v1124') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
