...
assert(serviceWorker.includes('requete-2026-09-27-premium-v1115') && html.includes('requete-2026-09-27-premium-v1115') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
