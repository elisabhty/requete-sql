...
assert(serviceWorker.includes('requete-2026-09-27-pairs-v1117') && html.includes('requete-2026-09-27-pairs-v1117') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
