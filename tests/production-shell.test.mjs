...
assert(html.includes('class="journey-shortcuts"') && html.includes('Tester tes requêtes'), 'raccourcis console et cartes accessibles sur l’accueil');
...
assert(serviceWorker.includes('requete-2026-09-26-norecap41-v1109') && html.includes('requete-2026-09-26-norecap41-v1109') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
