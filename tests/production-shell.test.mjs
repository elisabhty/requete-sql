...
assert(serviceWorker.includes('requete-2026-09-26-tables-v1106') && html.includes('requete-2026-09-26-tables-v1106') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
