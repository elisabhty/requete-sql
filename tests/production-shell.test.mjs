...
assert(serviceWorker.includes('requete-2026-09-27-objectif-v1123') && html.includes('requete-2026-09-27-objectif-v1123') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
