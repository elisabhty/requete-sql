...
assert(serviceWorker.includes('requete-2026-09-27-onmulti-v1128') && html.includes('requete-2026-09-27-onmulti-v1128') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
