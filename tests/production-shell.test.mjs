...
assert(serviceWorker.includes('requete-2026-09-26-jcgate-v1110') && html.includes('requete-2026-09-26-jcgate-v1110') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
