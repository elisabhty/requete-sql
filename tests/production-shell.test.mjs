...
assert(serviceWorker.includes('requete-2026-09-26-l41clean-v1105') && html.includes('requete-2026-09-26-l41clean-v1105') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
