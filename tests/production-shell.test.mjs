...
assert(serviceWorker.includes('requete-2026-09-27-bravo-v1118') && html.includes('requete-2026-09-27-bravo-v1118') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
