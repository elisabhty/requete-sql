...
assert(serviceWorker.includes('requete-2026-09-26-self6-v1112') && html.includes('requete-2026-09-26-self6-v1112') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
