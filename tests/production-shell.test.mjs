...
assert(serviceWorker.includes('requete-2026-09-27-onwhere2-v1129') && html.includes('requete-2026-09-27-onwhere2-v1129') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
