...
assert(serviceWorker.includes('requete-2026-09-26-plus1view-v1107') && html.includes('requete-2026-09-26-plus1view-v1107') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
