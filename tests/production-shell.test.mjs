...
assert(serviceWorker.includes('requete-2026-09-26-journey-v1103') && html.includes('requete-2026-09-26-journey-v1103') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
