...
assert(serviceWorker.includes('requete-2026-09-27-onwhere-v1127') && html.includes('requete-2026-09-27-onwhere-v1127') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
