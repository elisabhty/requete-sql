...
assert(serviceWorker.includes('requete-2026-09-25-journey-v1086') && html.includes('requete-2026-09-25-journey-v1086') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
