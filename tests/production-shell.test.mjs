...
assert(serviceWorker.includes('requete-2026-09-27-condanim-v1131') && html.includes('requete-2026-09-27-condanim-v1131') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
