...
assert(serviceWorker.includes('requete-2026-09-27-mission-v1116') && html.includes('requete-2026-09-27-mission-v1116') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
