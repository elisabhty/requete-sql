...
assert(serviceWorker.includes('requete-2026-09-27-nopers2-v1125') && html.includes('requete-2026-09-27-nopers2-v1125') && serviceWorker.includes("'./home-journey.css'"), 'cache et nouvelle feuille de style synchronisés');
