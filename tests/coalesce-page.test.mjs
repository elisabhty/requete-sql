...
assert(lesson.includes('premier choix disponible'), 'règle centrale formulée dans le titre');
assert(lesson.includes('coal-route') && lesson.includes('1er choix') && lesson.includes('repli'), 'lecture de gauche à droite matérialisée');
assert(lesson.includes('L’e-mail existe') && lesson.includes('L’e-mail vaut NULL'), 'les deux branches sont comparables');
